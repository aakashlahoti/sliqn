...
clear all
clear
fprintf("#############Started preprocessing dataset#############\n");
[labels, features] = libsvmread('../Data/segment.txt');
...
fprintf("#############Ended preprocessing dataset#############\n");
%% Initialization
...
hold off
savefig('../Matlab_plots/segment_p_21.fig');
